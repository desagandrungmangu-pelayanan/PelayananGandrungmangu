        ...
        <div className="grid gap-10 lg:grid-cols-4">
          ...
          <div>
            ...
            <ul className="mt-5 space-y-4 text-sm text-slate-400">
              <li className="flex gap-3"><MapPin className="mt-0.5 h-4 w-4 shrink-0 text-blue-400" /><span>Jalan Raya No.101, Gandrungmangu, Kec. Gandrungmangu, Cilacap</span></li>
              <li className="flex gap-3"><Phone className="mt-0.5 h-4 w-4 shrink-0 text-blue-400" /><span>0822-2548-3566</span></li>
              <li className="flex gap-3"><Mail className="mt-0.5 h-4 w-4 shrink-0 text-blue-400" /><span>desagandrungmangu@gmail.com</span></li>
              <li className="flex gap-3"><Clock3 className="mt-0.5 h-4 w-4 shrink-0 text-blue-400" /><span>Senin - Jumat, 08.00 - 16.00 WIB</span></li>
            </ul>
          </div>
          ...
          <div className="flex flex-col items-start gap-4 lg:items-end lg:text-right">
            ...
            <div className="flex gap-3">
              <a href="#" target="_blank" rel="noopener noreferrer" className="flex h-10 w-10 items-center justify-center rounded-full border border-white/10 bg-white/5 text-slate-300 transition-colors hover:border-blue-400 hover:text-white" aria-label="Facebook Desa Gandrungmangu">
                <Facebook className="h-4 w-4" />
              </a>
              <a href="https://www.instagram.com/pemdesGandrungmangu/" target="_blank" rel="noopener noreferrer" className="flex h-10 w-10 items-center justify-center rounded-full border border-white/10 bg-white/5 text-slate-300 transition-colors hover:border-blue-400 hover:text-white" aria-label="Instagram Desa Gandrungmangu">
                <Instagram className="h-4 w-4" />
              </a>
              <a href="https://www.tiktok.com/@pemdes.gandrungmangu" target="_blank" rel="noopener noreferrer" className="flex h-10 w-10 items-center justify-center rounded-full border border-white/10 bg-white/5 text-slate-300 transition-colors hover:border-blue-400 hover:text-white" aria-label="TikTok Desa Gandrungmangu">
              ...
              <a href="#" target="_blank" rel="noopener noreferrer" className="flex h-10 w-10 items-center justify-center rounded-full border border-white/10 bg-white/5 text-slate-300 transition-colors hover:border-blue-400 hover:text-white" aria-label="YouTube Desa Gandrungmangu">
