      ...
      >
        ...
        <div className="relative grid items-center gap-8 p-8 lg:grid-cols-[1fr_auto] lg:gap-12 lg:p-12">
          ...
          <div className="space-y-6">
            <div className="inline-flex items-center gap-2 rounded-full border border-blue-200 bg-blue-50 px-4 py-2 text-xs font-bold uppercase tracking-[0.25em] text-blue-700">
          ...
          <div className="flex flex-col items-start gap-4 lg:items-center">
            <div className="flex h-20 w-20 items-center justify-center rounded-2xl bg-blue-900 text-white shadow-xl shadow-blue-900/20">
              <MessageSquareWarning className="h-9 w-9" />
            </div>
            <Link href="/pengaduan" aria-label="Buat pengaduan warga">
              <Button className="h-11 rounded-full bg-blue-900 px-6 font-semibold text-white transition-all duration-300 hover:-translate-y-0.5 hover:bg-blue-950 shadow-[0_12px_30px_rgba(30,58,138,0.2)]">
                Buat Pengaduan
