    ...
    <section className="mx-auto max-w-7xl px-4 py-24 sm:px-6 lg:px-8 lg:py-28 overflow-hidden">
      ...
      >
        <div className="max-w-2xl">
          <p className="text-sm font-semibold uppercase tracking-[0.3em] text-blue-700">Berita Terbaru</p>
        ...
        <Link href="/BeritaDesa" className="inline-flex items-center gap-2 text-sm font-semibold text-blue-700">
          Lihat semua berita
        ...
        <div className="mt-12 relative w-full overflow-hidden marquee-gradient-mask">
          <div className="animate-marquee-slow flex gap-6 py-4">
            {duplicatedNews.map((item, idx) => (
              <motion.article
                key={`${item.id}-${idx}`}
                className="w-[340px] sm:w-[380px] shrink-0 group overflow-hidden rounded-[1.75rem] border border-blue-900/20 hover:border-blue-700/40 bg-white shadow-[0_20px_45px_rgba(15,23,42,0.04)] transition-all duration-300"
                whileHover={{ y: -6 }}
              >
                ...
                <div className="p-6">
                  ...
                  <h3 className="mt-3 text-lg font-semibold text-slate-900 line-clamp-2 h-14 leading-6 group-hover:text-blue-900 transition-colors">
                    {item.title}
                  </h3>
      ...
      <motion.div
        ...
        className="mt-16 rounded-[2rem] border border-blue-900/20 bg-white p-6 shadow-[0_20px_45px_rgba(15,23,42,0.04)] lg:p-8"
      >
        <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
          <div>
            <p className="text-sm font-semibold uppercase tracking-[0.3em] text-blue-700">Video Profil Desa</p>
          ...
          {youtubeEmbedUrl ? (
            ...
            <div className="flex h-full min-h-[320px] items-center justify-center bg-slate-950 text-center text-slate-200">
              <div className="space-y-3 px-6">
                <div className="mx-auto flex h-12 w-12 items-center justify-center rounded-full bg-blue-900 text-white">
