      ...
      <Card className="w-full max-w-md shadow-xl border-blue-100">
        <CardHeader className="text-center space-y-4">
          ...
          <div className="space-y-2">
            <CardTitle className="text-2xl font-bold text-blue-950">Portal Layanan Digital</CardTitle>
        ...
        <CardContent>
          <Button onClick={() => router.push('/dashboard')} className="w-full h-12 bg-blue-900 hover:bg-blue-950 text-lg font-semibold">
            Masuk ke Dashboard
