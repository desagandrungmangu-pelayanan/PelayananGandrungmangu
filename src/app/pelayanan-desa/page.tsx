...
export default function PelayananDesaPage() {
  ...
  const tabs = [
    ...
    { id: 'standar', label: 'Standar Pelayanan', icon: ClipboardCheck, color: 'text-blue-600', description: 'Syarat, biaya, dan waktu pengurusan.' },
          ...
          <main className="lg:col-span-9 space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-700">
            <div className="space-y-1">
              ...
              <p className="text-sm text-slate-500 font-medium max-w-2xl">
                Pusat informasi persyaratan, standar, dan dokumen administrasi Desa Gandrungmangu.
              </p>
            </div>
...
function CategoryContent({ categoryId, docs, isLoading }: { categoryId: string; docs: PelayananDoc[] | null | undefined; isLoading: boolean }) {
  ...
  switch (categoryId) {
            ...
            <Card className="rounded-3xl md:rounded-[2.5rem] border-none shadow-sm bg-primary text-white overflow-hidden">
              ...
              <CardContent className="p-6 md:p-8 pt-0">
                <p className="text-lg md:text-xl font-medium leading-relaxed italic">
                  "Terwujudnya pelayanan desa yang cepat, transparan, dan akuntabel demi kesejahteraan masyarakat Desa Gandrungmangu."
                </p>
              </CardContent>
            </Card>
      ...
      return (
        <Card className="rounded-3xl md:rounded-[3rem] border-none shadow-sm bg-white overflow-hidden border-t-8 border-primary">
          <CardContent className="p-6 md:p-12 space-y-8 text-center max-w-3xl mx-auto">
            ...
            <div className="pt-6">
              <p className="text-[10px] font-black uppercase tracking-[0.4em] text-slate-400">Pemerintah Desa Gandrungmangu</p>
            </div>
          </CardContent>
        </Card>
      );
        ...
        <div className="space-y-8">
          <div className="p-6 md:p-8 bg-amber-50 border-2 border-dashed border-amber-200 rounded-3xl md:rounded-[2.5rem] flex flex-col sm:flex-row items-center sm:items-start text-center sm:text-left gap-4 sm:gap-6">
            ...
            <div className="space-y-1">
              ...
              <p className="text-xs md:text-sm font-medium text-amber-700">Seluruh pelayanan administrasi di Desa Gandrungmangu adalah <strong>GRATIS (Rp. 0,-)</strong>.</p>
            </div>
          </div>
          <div className="grid md:grid-cols-2 gap-8">
            {[
      ...
      return (
        <div className="grid md:grid-cols-3 gap-8">
          <Card className="md:col-span-1 rounded-3xl md:rounded-[2.5rem] bg-slate-900 text-white p-6 md:p-8 flex flex-col items-center justify-center text-center space-y-4">
            ...
            <Badge className="bg-blue-600 text-white border-none font-bold px-4 py-1">SANGAT BAIK (A)</Badge>
          </Card>
          <Card className="md:col-span-2 rounded-3xl md:rounded-[2.5rem] bg-white border p-6 md:p-8 flex flex-col justify-center">
            ...
            <p className="text-xs md:text-sm text-slate-600 leading-relaxed font-medium">
              Berdasarkan hasil survei periode terakhir, tingkat kepuasan masyarakat Desa Gandrungmangu menunjukkan tren positif terutama pada aspek kesopanan petugas dan kecepatan waktu penyelesaian dokumen.
            </p>
          </Card>
        </div>
      );
    case 'survey':
      return (
        <Card className="rounded-3xl md:rounded-[3rem] border-none shadow-sm bg-blue-50 p-6 md:p-10 flex flex-col md:flex-row items-center gap-6 md:gap-8 border-2 border-blue-100">
          <div className="flex-1 space-y-4 text-center md:text-left">
            <h3 className="text-xl md:text-2xl font-black uppercase text-blue-950 font-display italic">Bantu Kami Meningkatkan Layanan</h3>
            <p className="text-xs md:text-sm text-blue-800/80 font-medium leading-relaxed">Partisipasi Anda dalam mengisi survey kepuasan sangat berarti bagi perbaikan kualitas pelayanan kami di masa depan. Klik tombol di samping untuk mengisi survey melalui Google Form.</p>
          </div>
          <Button size="lg" className="w-full md:w-auto bg-blue-900 hover:bg-blue-950 text-white rounded-xl font-black uppercase px-8 h-14 shadow-lg shadow-blue-200 justify-center" asChild>
