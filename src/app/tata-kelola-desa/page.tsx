    ...
    <div className="flex flex-col min-h-screen bg-slate-50 font-sans">
      ...
      <div className="flex-1 container mx-auto px-4 py-8 md:py-12">
        ...
        <div className="mb-12 space-y-4">
          ...
          <p className="text-slate-500 font-bold max-w-2xl">Transparansi anggaran dan produk hukum desa Gandrungmangu untuk akuntabilitas publik.</p>
        </div>
                ...
                <Card className="rounded-[2.5rem] border-none shadow-xl bg-gradient-to-br from-blue-50 to-indigo-50/50">
                  <CardContent className="p-8 flex flex-col md:flex-row md:items-center justify-between gap-6">
                    <div className="space-y-2">
                      ...
                      <p className="text-slate-500 font-medium">Rekapitulasi rencana anggaran belanja desa Gandrungmangu.</p>
                    </div>
            ...
            {isLoadingRealisasi ? (
              ...
              <>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                  {/* Total Card */}
                  <Card className="rounded-[2.5rem] border-none shadow-xl bg-gradient-to-br from-blue-50 to-slate-100 flex flex-col justify-between p-8 min-h-[220px]">
                    <div className="space-y-2">
                      <span className="text-xs font-black bg-blue-100 text-blue-900 px-3 py-1 rounded-full uppercase tracking-wider">Realisasi Anggaran Belanja</span>
                    ...
                    <div className="space-y-3 mt-4">
                      <div>
                        ...
                        <div className="text-3xl font-black text-blue-700 mt-1 font-display">
                  ...
                  <Card className="rounded-[2.5rem] border-none shadow-xl p-8 flex flex-col justify-between min-h-[220px]">
                    ...
                    <div className="my-4">
                      <div className="text-5xl md:text-6xl font-black text-blue-700 font-display italic">
                        {absorptionStats.formatted}
                      </div>
                      <div className="w-full bg-slate-100 rounded-full h-3 mt-3 overflow-hidden">
                        <div className="bg-blue-600 h-full rounded-full transition-all duration-1000" style={{ width: `${Math.min(100, absorptionStats.percentage)}%` }} />
                      </div>
                    </div>
      ...
      <footer className="bg-slate-900 text-white py-8 mt-16">
        <div className="container mx-auto px-4 text-center text-sm text-slate-400">
          © 2026 Pemerintah Desa Gandrungmangu Digital Portal - Tata Kelola Desa
        </div>
      </footer>
    </div>
  );
