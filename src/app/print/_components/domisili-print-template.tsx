  ...
  return (
    <PrintLayout submission={submission} hideRequesterSignature={true}>
      <p className="mt-8 text-justify leading-relaxed">
        Yang bertanda tangan dibawah ini, Kepala Desa Gandrungmangu, Kecamatan
      ...
      <p className="mt-6 text-justify leading-relaxed">
        Adalah benar penduduk Desa Gandrungmangu, Kecamatan Gandrungmangu, Kabupaten Cilacap dan saat ini berdomisili di :
      </p>
