        ...
        <footer className="px-[2cm] pb-[0cm] pt-4">
          <div className={cn("flex justify-between text-center items-start", reverseSignatures && "flex-row-reverse")}>
            <div className={cn("w-[40%]", hideRequesterSignature && "invisible")}>
              {reverseSignatures ? (
                <p className="mb-1">Gandrungmangu, {formattedDate}</p>
              ) : (
                <p className="invisible mb-1">Gandrungmangu, 00 Bulan 0000</p>
              )}
              <p>{requesterLabel}</p>
            ...
            <div className="w-[45%]">
              ...
              {signerType === 'sekdes' ? (
                <>
                  <p>A.n. Kepala Desa Gandrungmangu</p>
                  <p>Sekretaris Desa Gandrungmangu</p>
                  <div className="h-16"></div>
                  <p className="font-bold underline tracking-wider uppercase">MOH. HARYADI, S.Si.</p>
                </>
              ) : (
                <>
                  <p>Kepala Desa Gandrungmangu</p>
                  <div className="h-16"></div>
                  <p className="font-bold underline tracking-wider uppercase">NURYANI</p>
                </>
              )}
            </div>
          </div>
