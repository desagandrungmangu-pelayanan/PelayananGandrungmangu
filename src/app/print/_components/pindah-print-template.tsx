    ...
    <PrintLayout submission={submission}>
      ...
      <table className="mt-4 border-collapse w-full">
        <tbody>
          ...
          <DataRow label="Alamat Asal" value={`Desa Gandrungmangu, RT ${formData.currentAddressRt} / RW ${formData.currentAddressRw}, Kecamatan Gandrungmangu, Kabupaten Cilacap, Provinsi Jawa Tengah`} />
        </tbody>
      </table>
