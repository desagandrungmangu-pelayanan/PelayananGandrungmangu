  ...
  return (
    ...
    >
      <p className="mt-8 text-justify leading-relaxed">
        Yang bertanda tangan dibawah ini kepala Desa Gandrungmangu, Kecamatan Gandrungmangu, Kabupaten Cilacap, menerangkan dengan sebenarnya bahwa:
      </p>
      ...
      <p className="mt-4 text-justify leading-relaxed">
        Orang tersebut di atas adalah benar-benar penduduk Desa Gandrungmangu, Kecamatan Gandrungmangu, Kabupaten Cilacap.
      </p>
