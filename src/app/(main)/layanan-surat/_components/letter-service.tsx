...
const letterOptions = [
  ...
  { type: 'Surat Pengantar Pindah', icon: MapPinned, color: 'bg-cyan-100 text-cyan-700', description: 'Keterangan pindah domisili antar wilayah.' },
  ...
  { type: 'Surat Keterangan Moyang', icon: Users, color: 'bg-sky-100 text-sky-700', description: 'Keterangan silsilah keluarga / garis keturunan.' },
  { type: 'Surat Keterangan Pemakaman', icon: Flower2, color: 'bg-blue-100 text-blue-700', description: 'Ijin penguburan di makam umum desa.' },
