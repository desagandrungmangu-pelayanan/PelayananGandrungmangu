...
export default function PelayananCategoryPage() {
  ...
  const renderHeaderContent = () => {
    ...
    switch (categoryId) {
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-10">
            ...
            <Card className="md:col-span-2 rounded-[2.5rem] bg-white border p-8 flex flex-col justify-center">
              ...
              <p className="text-slate-600 leading-relaxed">
                Berdasarkan hasil survei periode terakhir, tingkat kepuasan masyarakat Desa Gandrungmangu menunjukkan tren positif terutama pada aspek kesopanan petugas and kecepatan waktu penyelesaian dokumen.
              </p>
            </Card>
          </div>
        );
      case 'survey':
        return (
          <Card className="rounded-[2.5rem] border-none shadow-sm bg-blue-50 p-10 mb-10 flex flex-col md:flex-row items-center gap-8">
            <div className="flex-1 space-y-4">
              <h3 className="text-2xl font-black uppercase text-blue-950 font-display italic">Bantu Kami Meningkatkan Layanan</h3>
              <p className="text-blue-800/80 font-medium">Partisipasi Anda dalam mengisi survey kepuasan sangat berarti bagi perbaikan kualitas pelayanan kami di masa depan.</p>
            </div>
            <Button size="lg" className="bg-blue-900 hover:bg-blue-950 text-white rounded-xl font-black uppercase px-8 h-14" asChild>
